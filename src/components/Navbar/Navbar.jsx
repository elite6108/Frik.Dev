...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed w-full z-50 top-0 left-0 backdrop-blur bg-white/80 dark:bg-gray-900/90 border-b border-gray-200 dark:border-gray-800 shadow-md transition-all duration-300">
